...
*/
class VanillaPlusWeaponAttachment_Falchion extends AOCWeaponAttachment_Falchion;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_Falchion'
	WeaponSocket=wep1hpoint

	AttackTypeInfo(0)=(fBaseDamage=78.0, fForce=8000, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=93.0, fForce=8000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=50.0, fForce=16000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
