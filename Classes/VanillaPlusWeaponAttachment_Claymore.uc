...
*/
class VanillaPlusWeaponAttachment_Claymore extends AOCWeaponAttachment_Claymore;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_Claymore'
	WeaponSocket=wep2hpoint

	bUseAlternativeKick=true

	AttackTypeInfo(0)=(fBaseDamage=75.0, fForce=25600, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=80.0, fForce=25600, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=70.0, fForce=26400, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
