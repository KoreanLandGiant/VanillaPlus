...
*/
class VanillaPlusWeaponAttachment_Dane extends AOCWeaponAttachment_Dane;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_Dane'

	WeaponSocket = wep1hpoint

	AttackTypeInfo(0)=(fBaseDamage=90.0, fForce=18000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
