class VanillaPlusFFAPlayerController extends AOCFFAPlayerController
    dependson(VanillaPlusFFA);
...
function ChangeToNewClass()
{
	...
	class'VanillaPlusCustomization'.static.GenerateSelectedWeaponDropSkinIndex(CustomizationInfo, self, WeaponDrops);
	bIsCustomizationInfoValid = class'VanillaPlusCustomization'.static.AreCustomizationChoicesValidFor(CustomizationInfo, EFAC_FFA, CurrentFamilyInfo.ClassReference, PlayerReplicationInfo, WeaponDrops);
