...
class VanillaPlusCharacterInfo_Mason_Archer extends AOCCharacterInfo_Mason_Archer;
defaultproperties
{
	...
	CharacterMeshPath="CH_A_MasonArcher_PKG.MasonArcherANIMRIG"
	DecapMeshPath="CH_A_MasonArcher_PKG.SkeletalMesh.Sk_CH_3P_MasonArcher"
	OwnerMeshPath="CH_A_MasonArcher_PKG.SkeletalMesh.SK_CH_1P_MAsonArcher"

	HeadMaterialPath="CH_A_MasonArcher_PKG.Materials.MI_CH_3P_MasonArcher_Body"
	BodyMaterialPath="CH_A_MasonArcher_PKG.Materials.MI_CH_3P_MasonArcher_Head"
	...
	Helmets.Add((SkeletalMeshPath="CH_A_MasonArcher_PKG.SkeletalMesh.SK_CH_MasonArcher_Helm01", StaticMeshPath="CH_sm_helms.smhelms_SK_CH_MasonArcher_Helm01",	    MaterialPath="CH_H_Gold.Materials.M_man_s",      GearData=(GearNameID=SilverHat, MinRank=1, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="CH_H_Veteran.m_a.sk_CH_MasonArcher_Helmet_Veteran",          StaticMeshPath="CH_H_Veteran.a_a.sm_CH_MasonArcher_Helmet_Veteran",	MaterialPath="CH_H_Gold.Materials.M_mav_b", GearData=(GearNameID=BlackHat, MinRank=1, bVisibleInSelectorIfUnowned=true)))	
	Helmets.Add((SkeletalMeshPath="CH_H_Veteran.m_a.sk_CH_MasonArcher_Helmet_Veteran",          StaticMeshPath="CH_H_Veteran.a_a.sm_CH_MasonArcher_Helmet_Veteran",	MaterialPath="CH_H_Gold.Materials.M_mav_g", GearData=(GearNameID=GoldHat, MinRank=1, bVisibleInSelectorIfUnowned=true)))	
	Helmets.Add((SkeletalMeshPath="CH_H_Veteran.m_a.sk_CH_MasonArcher_Helmet_Veteran",          StaticMeshPath="CH_H_Veteran.a_a.sm_CH_MasonArcher_Helmet_Veteran",	MaterialPath="CH_H_Gold.Materials.M_mav_p", GearData=(GearNameID=PinkHat, MinRank=1, bVisibleInSelectorIfUnowned=true)))	
	...
	Helmets.Add((SkeletalMeshPath="CH_VanillaPlus.SK_Cowboy", StaticMeshPath="CH_VanillaPlus.SM_Cowboy", GearData=(GroupHexID="1700000027DC808", GearNameID=Cowboy, bVisibleInSelectorIfUnowned=false)))
	Helmets.Add((SkeletalMeshPath="CH_VanillaPlus.SK_baseball", StaticMeshPath="CH_VanillaPlus.SM_baseball", GearData=(GroupHexID="170000002457482", GearNameID=Oakland_As, bVisibleInSelectorIfUnowned=false)))
