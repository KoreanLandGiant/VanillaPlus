...
*/
class VanillaPlusWeaponAttachment_MorningStar extends AOCWeaponAttachment_MorningStar;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_MorningStar'

	WeaponSocket=wep1hpoint
	WeaponStaticMeshScale=1

	AttackTypeInfo(0)=(fBaseDamage=65.0, fForce=16400, cDamageType="AOC.AOCDmgType_PierceBlunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=70.0, fForce=18000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
