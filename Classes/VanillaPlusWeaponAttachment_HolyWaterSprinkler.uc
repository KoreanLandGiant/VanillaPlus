...
*/
class VanillaPlusWeaponAttachment_HolyWaterSprinkler extends AOCWeaponAttachment_HolyWaterSprinkler;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_HolyWaterSprinkler'
