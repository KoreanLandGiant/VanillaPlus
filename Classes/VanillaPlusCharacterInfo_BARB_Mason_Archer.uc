...
* 
*/
class VanillaPlusCharacterInfo_BARB_Mason_Archer extends AOCCharacterInfo_Archer;
...
defaultproperties
{
	...
	/** Ownership info **/
	GearData=(GearNameID=BarbMasonArcher, GearStoreDescriptionID=Barb_Archer_Bundle_1, bVisibleInSelectorIfUnowned=true, bPartOfBundle=false, MicroTxID=, BundleNameID=Barb_Archer_Bundle_1)
