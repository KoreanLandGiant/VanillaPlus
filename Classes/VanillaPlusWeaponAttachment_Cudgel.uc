...
*/
class VanillaPlusWeaponAttachment_Cudgel extends AOCWeaponAttachment_Cudgel;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_Cudgel'
	WeaponSocket=wep1hpoint

	AttackTypeInfo(0)=(fBaseDamage=40.0, fForce=10000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=62.0, fForce=10000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
