...
class VanillaPlusWeaponAttachment_DoubleAxe extends AOCWeaponAttachment_DoubleAxe;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_DoubleAxe'
	...
	Skins(2)={(
		...
		MaterialPath="",
		StaticMeshScale=1.0,
		ImagePath="ui_custweaponimages_swf.skin_pick_axe_png"
		)};
