...
*/
class VanillaPlusWeaponAttachment_BroadDagger extends AOCWeaponAttachment_BroadDagger;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_BroadDagger'
	WeaponSocket=wep1hpoint

	AttackTypeInfo(0)=(fBaseDamage=35.0, fForce=8000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=40.0, fForce=8000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=35.0, fForce=8000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
