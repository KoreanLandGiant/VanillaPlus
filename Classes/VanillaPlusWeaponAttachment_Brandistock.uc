...
*/
class VanillaPlusWeaponAttachment_Brandistock extends AOCWeaponAttachment_Brandistock;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_Brandistock'
	...
	AttackTypeInfo(2)=(fBaseDamage=65.0, fForce=0, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
