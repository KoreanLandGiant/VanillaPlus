...
*/
class VanillaPlusWeaponAttachment_WarAxe extends AOCWeaponAttachment_WarAxe;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_WarAxe'

	WeaponSocket = wep1hpoint

	WeaponStaticMeshScale=1

	AttackTypeInfo(0)=(fBaseDamage=70.0, fForce=16000, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=85, fForce=16000, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
