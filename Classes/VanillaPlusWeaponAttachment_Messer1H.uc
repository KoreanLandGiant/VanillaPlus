...
*/
class VanillaPlusWeaponAttachment_Messer1H extends AOCWeaponAttachment_Messer1H;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_Messer1H'
	...
	AttackTypeInfo(0)=(fBaseDamage=80.0, fForce=18000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=75.0, fForce=18000, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=50.0, fForce=18000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
	...
	Skins(5)={(
		...
		MaterialPath="",
		StaticMeshScale=1.0,
		ImagePath="ui_custweaponimages_swf.skin_savageReaver_png"
		)};
	Skins(6)={(
