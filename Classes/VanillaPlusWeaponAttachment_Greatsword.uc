...
*/
class VanillaPlusWeaponAttachment_Greatsword extends AOCWeaponAttachment_Greatsword;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_Greatsword'
	WeaponSocket=wep2hpoint

	bUseAlternativeKick=true

	AttackTypeInfo(0)=(fBaseDamage=85.0, fForce=26400, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=95.0, fForce=26400, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
