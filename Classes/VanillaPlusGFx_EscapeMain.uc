...
*/
class VanillaPlusGFx_EscapeMain extends AOCGFx_ViewManager;
...
var VanillaPlusView_Frontend_Customization  NewCustomizationOpView;
...
{    
	...
	//LogAlwaysInternal("VanillaPlusGFx_EscapeMain::WidgetInitialized"@Widget);
    ...
    {           
		case ('Customization'):
			...
			{
				NewCustomizationOpView = VanillaPlusView_Frontend_Customization(Widget);
...
{
	//LogAlwaysInternal("VanillaPlusGFx_EscapeMain::LoadViewByName"@InputName);
	switch (InputName)
	{
	case "ConfigMain":
...
defaultproperties
{
	...
	WidgetBindings.Add((WidgetName="Customization",WidgetClass=class'VanillaPlusView_Frontend_Customization'))
