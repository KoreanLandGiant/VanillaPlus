...
*/
class VanillaPlusWeaponAttachment_Zweihander extends AOCWeaponAttachment_Zweihander;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_Zweihander'
	...
	AttackTypeInfo(1)=(fBaseDamage=115.0, fForce=27200, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=70.0, fForce=28000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
