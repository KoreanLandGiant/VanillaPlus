...
*/
class VanillaPlusWeaponAttachment_Halberd extends AOCWeaponAttachment_Halberd;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_Halberd'
	...
	AttackTypeInfo(1)=(fBaseDamage=85.0, fForce=24000, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=75.0, fForce=0, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
