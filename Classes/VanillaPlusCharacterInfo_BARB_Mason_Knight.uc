...
* 
*/
class VanillaPlusCharacterInfo_BARB_Mason_Knight extends AOCCharacterInfo_BARB_Mason_Knight;
...
defaultproperties
{
	...
	//GearData=(GearNameID=MasonKnight,AppID=,bVisibleInSelectorIfUnowned=true)
	GearData=(GearNameID=BarbMasonKnight, GearStoreDescriptionID=Barb_Knight_Bundle_1, bVisibleInSelectorIfUnowned=true, bPartOfBundle=false, MicroTxID=, BundleNameID=Barb_Knight_Bundle_1)
	...
	Helmets.Add((SkeletalMeshPath="CH_NPC_Peasant.models.SK_PC_Peasant_Hat02",             StaticMeshPath="CH_sm_helms.smhelms_SK_NPC_Peasant_Hat02",              GearData=(GearNameID=Peasant, MicroTxID=1, bVisibleInSelectorIfUnowned=true)))
