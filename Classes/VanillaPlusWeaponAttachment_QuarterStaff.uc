...
*/
class VanillaPlusWeaponAttachment_QuarterStaff extends AOCWeaponAttachment_QuarterStaff;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_QuarterStaff'
	...
	AttackTypeInfo(0)=(fBaseDamage=45.0, fForce=18000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
