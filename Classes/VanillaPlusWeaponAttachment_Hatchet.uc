...
*/
class VanillaPlusWeaponAttachment_Hatchet extends AOCWeaponAttachment_Hatchet;
...
KickOffset=(X=50, Y=0, Z=-65)
	...
	WeaponClass=class'VanillaPlusWeapon_Hatchet'

	WeaponSocket = wep1hpoint

	AttackTypeInfo(0)=(fBaseDamage=40.0, fForce=16000, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
	AttackTypeInfo(1)=(fBaseDamage=55.0, fForce=16000, cDamageType="AOC.AOCDmgType_SwingBlunt", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=20.0, fForce=18000, cDamageType="AOC.AOCDmgType_Blunt", iWorldHitLenience=6)
