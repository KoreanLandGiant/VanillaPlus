...
* 
*/
class VanillaPlusCharacterInfo_BARB_Mason_Vanguard extends AOCCharacterInfo_Vanguard;
...
defaultproperties
{
	...
	//GearData=(GearNameID=MasonVanguard,AppID=,bVisibleInSelectorIfUnowned=true)
	GearData=(GearNameID=BarbMasonVanguard, GearStoreDescriptionID=Barb_Vanguard_Bundle_1, bVisibleInSelectorIfUnowned=true, bPartOfBundle=false, MicroTxID=, BundleNameID=Barb_Vanguard_Bundle_1)
	...
	Helmets.Add((SkeletalMeshPath="CH_H_Veteran.m_v.sk_CH_MasonVanguard_Helmet_Basic",      StaticMeshPath="CH_H_Veteran.a_a.sm_CH_MasonVanguard_Helmet_Basic", 	MaterialPath="CH_H_Gold.Materials.M_mvn_s",      GearData=(GearNameID=SilverHat, MinRank=1, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="CH_H_Veteran.m_v.sk_CH_MasonVanguard_Helmet_Veteran",    StaticMeshPath="CH_H_Veteran.a_a.sm_CH_MasonVanguard_Helmet_Veteran",	MaterialPath="CH_H_Gold.Materials.M_mvn_b", GearData=(GearNameID=BlackHat, MinRank=1, bVisibleInSelectorIfUnowned=true)))	
	Helmets.Add((SkeletalMeshPath="CH_H_Veteran.m_v.sk_CH_MasonVanguard_Helmet_Veteran",    StaticMeshPath="CH_H_Veteran.a_a.sm_CH_MasonVanguard_Helmet_Veteran",	MaterialPath="CH_H_Gold.Materials.M_mvn_g", GearData=(GearNameID=GoldHat, MinRank=1, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="CH_H_Veteran.m_v.sk_CH_MasonVanguard_Helmet_Veteran",    StaticMeshPath="CH_H_Veteran.a_a.sm_CH_MasonVanguard_Helmet_Veteran",	MaterialPath="CH_H_Gold.Materials.M_mvn_p", GearData=(GearNameID=PinkHat, MinRank=1, bVisibleInSelectorIfUnowned=true)))
	...
	Helmets.Add((SkeletalMeshPath="CH_Reiverhelm_Mason.SK_Reiverhelm_Mason",                StaticMeshPath="CH_Reiverhelm_Mason.SM_Reiverhelm_Mason",           GearData=(GearNameID=ReiverHelmMason, GearStoreDescriptionID=ReiverSet2, bVisibleInSelectorIfUnowned=true, bPartOfBundle=false, MicroTxID=, BundleNameID=ReiverSet2)))
	Helmets.Add((SkeletalMeshPath="CH_Reiverhelm_Mason.SK_Reiverhelm_Mason_Open",           StaticMeshPath="CH_Reiverhelm_Mason.SM_Reiverhelm_Mason_Open",      GearData=(GearNameID=ReiverHelmMasonOpen, GearStoreDescriptionID=ReiverSet2, bVisibleInSelectorIfUnowned=true, bPartOfBundle=false, MicroTxID=, BundleNameID=ReiverSet2)))
