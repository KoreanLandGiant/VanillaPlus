...
* 
*/
class VanillaPlusCharacterInfo_BARB_Agatha_Knight extends AOCCharacterInfo_BARB_Agatha_Knight;
...
defaultproperties
{
	...
	//GearData=(GearNameID=AgathaKnight,AppID=,bVisibleInSelectorIfUnowned=true)
	GearData=(GearNameID=BarbAgathaKnight, GearStoreDescriptionID=Barb_Knight_Bundle_1, bVisibleInSelectorIfUnowned=true, bPartOfBundle=false, MicroTxID=, BundleNameID=Barb_Knight_Bundle_1)
	...
	Helmets.Add((SkeletalMeshPath="CH_AgathanKnight_PKG.models.SK_CH_AgathaKnight_Helm02",      StaticMeshPath="CH_sm_helms.smhelms_SK_CH_Agathaknight_Helm02", 	    MaterialPath="CH_H_Gold.Materials.M_akn_s",      GearData=(GearNameID=SilverHat, MinRank=1, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="CH_H_Veteran.a_k.CH_AgathaKnight_HelmetUP_Veteran",         StaticMeshPath="CH_H_Veteran.a_a.sm_CH_AgathaKnight_Helmet_Veteran",	MaterialPath="CH_H_Gold.Materials.M_akv_b", GearData=(GearNameID=BlackHat, MinRank=1, bVisibleInSelectorIfUnowned=true)))	
	Helmets.Add((SkeletalMeshPath="CH_H_Veteran.a_k.CH_AgathaKnight_HelmetUP_Veteran",         StaticMeshPath="CH_H_Veteran.a_a.sm_CH_AgathaKnight_Helmet_Veteran",	MaterialPath="CH_H_Gold.Materials.M_akv_g", GearData=(GearNameID=GoldHat, MinRank=1, bVisibleInSelectorIfUnowned=true)))	
	...
	Helmets.Add((SkeletalMeshPath="CH_HP1_Agatha.Knight.sk_hp1a_knight",                        StaticMeshPath="CH_HP1_Agatha.Knight.sm_hp1a-knight",                   GearData=(GearNameID=Agatha_Knight_DLC_Helmet_1, MicroTxID=, bPartOfBundle=true, BundleNameID=Agatha_Bundle_DLC_Helmets_1, GearStoreDescriptionID=Agatha_Bundle_DLC_Helmets_1))) 
	Helmets.Add((SkeletalMeshPath="CH_HP1_Agatha.Knight.sk_hp1aNV-knight",                      StaticMeshPath="CH_HP1_Agatha.Knight.sm_hp1a-knight_lowhelm",           GearData=(GearNameID=Agatha_Knight_DLC_HelmetOpen_1, MicroTxID=, bPartOfBundle=true, BundleNameID=Agatha_Bundle_DLC_Helmets_1, GearStoreDescriptionID=Agatha_Bundle_DLC_Helmets_1))) 
	...
	Helmets.Add((SkeletalMeshPath="CH_H_RatHelmet.SK_Rat_Helmet",             StaticMeshPath="CH_H_RatHelmet.SM_Rat_Helmet",              GearData=(GearNameID=RatHelm, GearStoreDescriptionID=RatSet, bVisibleInSelectorIfUnowned=true, MicroTxID=, bPartOfBundle=true, BundleNameID=RatSet)))
