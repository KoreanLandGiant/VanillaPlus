...
* 
*/
class VanillaPlusCharacterInfo_Mason_Vanguard_DLC1 extends AOCCharacterInfo_Mason_Vanguard;
...
defaultproperties
{
	...
	GearData=(GearNameID=MasonVanguard_DLC1, GearStoreDescriptionID=Mason_Elite_Vanguard_Bundle_1, bPartOfBundle=false, bVisibleInSelectorIfUnowned=true, MicroTxID= BundleNameID=Mason_Elite_Vanguard_Bundle_1))
